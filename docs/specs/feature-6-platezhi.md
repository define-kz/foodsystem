# Техническая спецификация: Платежи
...
|--------|------|-------------|-------|
| GET | /api/v1/platezhi | List (paginated) | All |
| GET | /api/v1/platezhi/:id | Get by ID | All |
| POST | /api/v1/platezhi | Create | Owner, Manager |
| PATCH | /api/v1/platezhi/:id | Update | Owner, Manager |
| DELETE | /api/v1/platezhi/:id | Soft delete | Owner |
