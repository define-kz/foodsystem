# Техническая спецификация: Система доставки
...
## Модуль: `src/sistema_dostavki/`

### Prisma Schema
```prisma
model Sistemadostavki {
...
|--------|------|-------------|-------|
| GET | /api/v1/sistema_dostavki | List (paginated) | All |
| GET | /api/v1/sistema_dostavki/:id | Get by ID | All |
| POST | /api/v1/sistema_dostavki | Create | Owner, Manager |
| PATCH | /api/v1/sistema_dostavki/:id | Update | Owner, Manager |
| DELETE | /api/v1/sistema_dostavki/:id | Soft delete | Owner |
