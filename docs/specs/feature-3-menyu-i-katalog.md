# Техническая спецификация: Меню и каталог
...
|--------|------|-------------|-------|
| GET | /api/v1/menyu_i_katalog | List (paginated) | All |
| GET | /api/v1/menyu_i_katalog/:id | Get by ID | All |
| POST | /api/v1/menyu_i_katalog | Create | Owner, Manager |
| PATCH | /api/v1/menyu_i_katalog/:id | Update | Owner, Manager |
| DELETE | /api/v1/menyu_i_katalog/:id | Soft delete | Owner |
