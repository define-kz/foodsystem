...
@Controller('api/v1/avtorizatsiya_i_registratsiya')
export class AvtorizatsiyaIRegistratsiyaController {
  constructor(private readonly service: AvtorizatsiyaIRegistratsiyaService) {}
