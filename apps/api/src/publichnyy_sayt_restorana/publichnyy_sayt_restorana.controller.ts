...
@Controller('api/v1/publichnyy_sayt_restorana')
export class PublichnyySaytRestoranaController {
  constructor(private readonly service: PublichnyySaytRestoranaService) {}
